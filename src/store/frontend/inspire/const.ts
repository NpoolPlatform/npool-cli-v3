enum API {
  GET_INVITATION_CODE = '/cloud-hashing-inspire/v1/get/user/invitation/code/by/app/user',
  ...
  UPDATE_INVITATION_CODE = '/cloud-hashing-inspire/v1/update/user/invitation/code',
